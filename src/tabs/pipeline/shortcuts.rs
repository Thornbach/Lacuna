...
pub const ACTIONS: &[ActionDef] = &[
    ...
    ActionDef { id: "review.undo", group: "Detections", label: "Undo last edit",
        hint: "Reverses the last edit, including a paint or eraser stroke. Also Ctrl+Z.",
        default_key: Key::F35 },
    ActionDef { id: "review.redo", group: "Detections", label: "Redo last undone edit",
        hint: "Puts back what Undo removed. Also Ctrl+Y.",
        default_key: Key::F35 },
